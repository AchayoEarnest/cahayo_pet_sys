"""
Cahayo FMS - Production Settings
...
DATABASES = {
    "default": {
        ...
        "USER": env("DB_USER", default="cahayo"),
...
LOGGING = {
    ...
    "handlers": {
        ...
        "file": {
            ...
            "filename": BASE_DIR / "logs/cahayo.log",
    ...
    "loggers": {
        "apps.mpesa": {"handlers": ["console", "file"], "level": "DEBUG", "propagate": False},
        "apps.shifts": {"handlers": ["console", "file"], "level": "INFO", "propagate": False},
    },
}
